#!/usr/bin/env python3
"""Run every certificate used by the shortened manuscript."""
...
COMMANDS = [
    ("contact_isolator", [sys.executable, str(ROOT / "contact_isolator.py")]),
    ("forcing", [sys.executable, str(ROOT / "erdos1038_forcing_exact.py")]),
    ("endpoint", [sys.executable, str(ROOT / "erdos1038_exact_endpoint_certificate.py"), "--workers", "1"]),
