...
**Contributor.** Binghui Peng, [Hantao Yu](https://www.hantaoyu.org/), Runzhou Tao, Steven Wang, Diyi Liu, Tamás Darvas

**Proof discovery.** The proofs are generated by GPT-5.5 Pro via a simple
prover–verifier pipeline; the papers are
polished and verified by the contributor.
...
## News
- **2026-07-15:** Added write-up for Erdős **Problem 1038** - [paper](papers/erdos1038/Erdos_1038.pdf).
...
### Erdős problems
- **Problem 477:**  — [paper](papers/tiling-complement.pdf)
- **Problem 1038:** — [paper](papers/erdos1038/Erdos_1038.pdf)
...
- **Minimum edge-outerplanar embeddings are poly-time computable** - [paper](https://arxiv.org/abs/2607.08110).
